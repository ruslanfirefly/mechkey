...
Алсо вдохновившись QMK/TMK сделали [ZMK Firmware](https://zmkfirmware.dev/), ориентированную на беспроводные контроллеры (сейчас это практически безальтернативный выбор).
